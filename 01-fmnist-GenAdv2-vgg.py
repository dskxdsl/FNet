...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename='01vgg_GenAdv_log2.txt',
                    filemode='w')
...
path = './models/FmnistVGG16.pt'
net = M.get_MnistVGG16()
...
fmnist_file = open(path,'rb')
mean = pickle.load(fmnist_file)
std = pickle.load(fmnist_file)
...
batch_size = 1
_,_,Clean_data_iter,Test_Clean_data_iter = d2l.load_fmnist_dataset(data_dir,batch_size=batch_size,transform=preprocess)

...
def val_fgsm():
    ...
    # 获取数据
    data_dir = './datasets/cifar10-resnet-test/clean-fgsm/' #'/Datasets/cifar-10/'
    batch_size = 64
    mini_batchsize = 32
    ...
    adv_test_path = './Datasets-KDBU/adv/test/resnet/fgsm/'
    ...
    pic_title = 'FGSM(CIFAR_10,ResNet)'
...
def val_cw():
    ...
    # 获取数据
    data_dir = './datasets/cifar10-resnet-test/clean-cw/' #'/Datasets/cifar-10/'
    batch_size = 64
    mini_batchsize = 32
    ...
    adv_test_path = './Datasets-KDBU/adv/test/resnet/cw/'
    fpr,tpr,AUC = testKDBU(base_model,base_model_path,kdes,lrmodel_path,adv_test_path)
    AUC = ('%.4f' %AUC)
    fpr_list.append(fpr)
    tpr_list.append(tpr)
...
def val_dp():
    ...
    # 获取数据
    data_dir = './datasets/cifar10-resnet-test/clean-dp/' #'/Datasets/cifar-10/'
    batch_size = 64
    mini_batchsize = 32
    ...
    adv_test_path = './Datasets-KDBU/adv/test/resnet/dp/'
    fpr,tpr,AUC = testKDBU(base_model,base_model_path,kdes,lrmodel_path,adv_test_path)
    AUC = ('%.4f' %AUC)
    fpr_list.append(fpr)
    tpr_list.append(tpr)
    ...
    ##########################################
    #=========================================
    pic_title = 'DeepFool(CIFAR_10,ResNet)'
    d2l.plot_roc(fpr_list,tpr_list,AUC_list,model_name,pic_title)

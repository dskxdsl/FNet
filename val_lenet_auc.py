...
def val_fgsm():
    ...
    # 获取数据
    data_dir = './datasets/cifar10-LeNet-test/clean-fgsm/' #'/Datasets/cifar-10/'
    batch_size = 64
    mini_batchsize = 32
    ...
    adv_test_path = './Datasets-KDBU/adv/test/lenet/fgsm/'
...
def val_cw():
    ...
    # 获取数据
    data_dir = './datasets/cifar10-LeNet-test/clean-cw/' #'/Datasets/cifar-10/'
    batch_size = 64
    mini_batchsize = 32
    ...
    adv_test_path = './Datasets-KDBU/adv/test/lenet/cw/'
    fpr,tpr,AUC = testKDBU(base_model,base_model_path,kdes,lrmodel_path,adv_test_path)
    AUC = ('%.4f' %AUC)
    fpr_list.append(fpr)
    tpr_list.append(tpr)
...
def val_dp():
    ...
    # 获取数据
    data_dir = './datasets/cifar10-LeNet-test/clean-dp/' #'/Datasets/cifar-10/'
    batch_size = 64
    mini_batchsize = 32
    ...
    adv_test_path = './Datasets-KDBU/adv/test/lenet/dp/'
    fpr,tpr,AUC = testKDBU(base_model,base_model_path,kdes,lrmodel_path,adv_test_path)
    AUC = ('%.4f' %AUC)
    fpr_list.append(fpr)
    tpr_list.append(tpr)
    ...
    ##########################################
    #=========================================
    pic_title = 'DeepFool(CIFAR_10,LeNet)'
    d2l.plot_roc(fpr_list,tpr_list,AUC_list,model_name,pic_title)

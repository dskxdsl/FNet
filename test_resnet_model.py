...
class Logger(object):
    ...
    def flush(self):
        pass
sys.stdout = Logger('./log/test_resnet_model_log.txt')
...
def testFnet_fgsm():
    dataset_path = './datasets/cifar10-resnet-test/clean-fgsm/'
...
def testFnet_cw():
    dataset_path = './datasets/cifar10-resnet-test/clean-cw/'
    model = M.get_FNet(num_classes=2)
    ...
    testFnetModel(dataset_path,model,model_path,batch_size,mini_batchsize)
def testFnet_dp():
    dataset_path = './datasets/cifar10-resnet-test/clean-dp/'
    model = M.get_FNet(num_classes=2)
